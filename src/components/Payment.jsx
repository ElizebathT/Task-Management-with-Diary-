...
const Payment = () => {
  return (
    <section className="bg-yellow-500 py-8 antialiased dark:bg-gray-900 md:py-16">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
            ...
            <div className="mt-6 grow sm:mt-8 lg:mt-0">
              <div className="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 bg-gray-800">
